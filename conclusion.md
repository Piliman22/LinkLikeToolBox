...
> [!CAUTION]
> ⚠️ 本記事は技術検証・学習目的で書かれたものであり、著作権の侵害や不正アクセスなどを助長する意図は一切ありません。  
> ゲーム開発者様の権利を尊重し、個人利用の範囲に留めてください。
...
創作譜面に触れている自分としては、譜面を自作し撮影ができたら面白いと思い立ちました。
...
- [apk](#apk)
- [frida](#frida)
  - [Frida-gadgetの導入](#frida-gadgetの導入)
  - [HMACSHA1の鍵抽出](#hmacsha1の鍵抽出)
- [API](#api)
  - [マニフェストについて](#マニフェストについて)
  - [MitmProxyでのパケットキャプチャ](#mitmproxyでのパケットキャプチャ)
  - [x-res-versionについて](#x-res-versionについて)
  - [アセットダウンロードの流れ](#アセットダウンロードの流れ)
- [アセットの複合](#アセットの複合)
- [データ形式の解析](#データ形式の解析)
- [自動化システム](#自動化システム)
- [まとめ](#まとめ)
...
このままでは正体不明で手がかりがつかめませんので、マニフェストを複合化、もしくはAPIの中間攻撃を利用する以外厳しいです。
